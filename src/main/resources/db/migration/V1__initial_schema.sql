...
CREATE TYPE SEAT_HOLD_STATUS AS ENUM('HOLD', 'COMPLETED', 'EXPIRED');
...
CREATE TABLE trips(
    ...
    bus_id BIGINT,
    date DATE NOT NULL,
    departure_at pg_catalog.timestamptz NOT NULL,
    arrival_eta pg_catalog.timestamptz NOT NULL,
...
CREATE TABLE assignments(
    ...
    assigned_at pg_catalog.timestamptz NOT NULL DEFAULT pg_catalog.now(),
...
CREATE TABLE offline_sales(
    ...
    created_at pg_catalog.timestamptz NOT NULL DEFAULT pg_catalog.now(),
    synced_at pg_catalog.timestamptz,
    ticket_id BIGINT,
